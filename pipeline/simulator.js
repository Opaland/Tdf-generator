...
const GAZETTEER = [
  ...
  { name: 'Col du Lautaret', lat: 45.0344, lon: 6.4050, ele: 2058, kind: 'peak' },
  ...
  { name: "Col d'Allos", lat: 44.2670, lon: 6.5830, ele: 2250, kind: 'peak' },
  { name: 'Col de Vars', lat: 44.5350, lon: 6.7000, ele: 2108, kind: 'peak' },
  { name: 'Colle Saint-Michel', lat: 44.0800, lon: 6.6000, ele: 1431, kind: 'peak' },
  { name: 'Briançon', lat: 44.8970, lon: 6.6390, ele: 1326, kind: 'city' },
